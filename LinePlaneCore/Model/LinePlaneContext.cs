...
namespace LinePlaneCore
{
    public class LinePlaneContext: DbContext
    {
        ...
        protected override void OnConfiguring( DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Data Source=WIN-G4RME6E5PVS\LINEPLANESERVER;Initial Catalog=fgfdsfsdfdsfdsfdsfdsfdsfdsdsfdsfdsfsdfsdfsdfsd;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
